<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex justify-between items-center py-6">
        ...
        <button onclick="window.location='{{ route('admin/jadwals/create') }}'" class="btn btn-primary btn-sm">Add Jadwal</button>
    </div>
            ...
            <tbody class="text-gray-600 text-sm font-light">
                ...
                <tr class="border-b border-gray-200 hover:bg-gray-100">
                    ...
                    <td class="py-3 px-6 text-left">
                        <div class="d-flex">
                            <button onclick="window.location='{{ route('admin/jadwals/edit', $rs->id)}}'" class="btn btn-success btn-sm mr-2">Edit</button>
                            <form action="{{ route('admin/jadwals/destroy', $rs->id) }}" method="POST" onsubmit="return confirm('Yakin Ingin Menghapus?')" class="inline">
                                @csrf
                                @method('DELETE')
